...
gemini_client, detector, brush_thick, eraser_thick, rectKernel, options, counter_map, blkboard = set_basic_config()
                ...
                try:
                    ...
                    if result and chat is None:
                        with st.chat_message("assistant", avatar="🦉"):
                            ...
                            #     stream=True,
                            # )
                            image_description = "This is an image of a mathematical problem. Please solve it in Markdown format."
                            stream = gemini_client.generate_content(
                                f"{image_description}\n\nHere is the image in base64: data:image/png;base64,{base64_image}",
